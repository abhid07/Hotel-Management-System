...
class frame1(Frame):
    def __init__(self):
        ...
        self.lab=Label(self,text="     HUNGRY DUCKS ",bg="orange")
        ...
        self.lab2=Label(self,text="ADDRESS: GROUND FLOOR,ATLANTA APARTMENTS,SECTION-A,ANJURPHATA,BHIWANDI",bg="orange")
...
class frame2(Frame):
    def __init__(self,root):
        ...
        self.ph=Label(root,image=self.photo,bg="white")
        self.ph.place(x=200,y=50)
        ...
        self.but2=Button(root,text="LOG IN",fg="white",bg="green",command=self.nextw1b)
        ...
        self.la2=Label(root,text="ADDRESS: GROUND FLOOR,ATLANTA APARTMENTS,SECTION-A,ANJURPHATA,BHIWANDI",bg="orange")
...
class frame3(Frame):
    def __init__(self,root1):
        ...
        self.root1.configure(bg="green yellow")

        self.la1=Label(root1,text="HUNGRY DUCKS",bg="orange")
        self.la1.config(font=("times new roman",44))
        self.la1.place(x=400,y=10)
        self.la2=Label(root1,text="FIRST NAME",width=12)
        self.la2.config(font=("times new roman",20))
        self.e1=Entry(root1,bd=3, width=30)
        ...
        self.e2=Entry(root1,bd=3, width=30)
        ...
        self.e3=Entry(root1,bd=3, width=30)
        ...
        self.e4=Entry(root1,bd=3, width=30)
        ...
        self.e5=Entry(root1,bd=3, width=30,show='*')
        ...
        self.e6=Entry(root1,bd=3, width=30,show='*')
        ...
        self.la2=Label(root1,text="ADDRESS: GROUND FLOOR,ATLANTA APARTMENTS,SECTION-A,ANJURPHATA,BHIWANDI",bg="orange")
        self.la2.config(font=("times new roman",20))
...
class frame4(Frame):
    def __init__(self,root2):
        ...
        self.la2=Label(root2,text="ADDRESS: GROUND FLOOR,ATLANTA APARTMENTS,SECTION-A,ANJURPHATA,BHIWANDI",bg="orange")
        self.la2.config(font=("times new roman",20))
...
class frame5(Frame):
    def __init__(self,master):
        ...
        self.lab8=Label(master,text="ADDRESS: GROUND FLOOR,ATLANTA APARTMENTS,SECTION-A,ANJURPHATA,BHIWANDI",bg="black",fg="white")
...
class snacks(Frame):
    ...
    def __init__(self,master):
        ...
        self.add3=Button(master,text="ADD",bg="white",fg="RED",command=self.item3)
        self.add3.config(font=("bookman old style",15))
        ...
        self.photo=PhotoImage(file='pasta.png')
        self.lab1=Label(master,image=self.photo,bg="orange")
        self.lab1.place(x=1000,y=130)
        self.photo1=PhotoImage(file='fries.png')
        self.lab3=Label(master,image=self.photo1,bg="orange")
        self.lab3.place(x=1000,y=313)
        self.photo2=PhotoImage(file='pizza.png')
...
class maincourse1(Frame):
    def __init__(self,master):
        ...
        self.add5.config(font=("bookman old style",15))
        self.add5.place(x=700,y=405)
        self.add6=Button(master,text="ADD",bg="white",fg="RED",command=self.item3)
        self.add6.config(font=("bookman old style",15))
        self.add6.place(x=700,y=460)
        self.add7=Button(master,text="ADD",bg="white",fg="RED")
        self.add7.config(font=("bookman old style",15))
...
class cart(Frame):
    ...
    def bill(self):
        c.execute("select count(item_id) from purchases")
        x=c.fetchone()
        if(x[0]==0):
            messagebox.showerror("Cart Empty!","No items in your cart")
        else:
            self.master.destroy()
            a=Tk()
            ob=viewBill(a)
    ...
    def logout(self):
        c.execute("delete from purchases where uname=?",(my_user.uname,))
        conn.commit()
        self.master.destroy()
        d=Tk()
        aa=frame4(d)
        
class viewBill(Frame):
    def __init__(self,master):
        Frame.__init__(self,master=None)
        self.master=master
        self.master.geometry('1350x800')
        self.master.configure(bg="orange")
        self.lab3=Label(master,text="GROUND FLOOR,ATLANTA APARTMENTS,SECTION-A,ANJURPHATA,BHIWANDI",bg="orange",fg="black")
        self.lab3.config(font=("algerian",15))
        self.lab3.place(x=325,y=110)
        self.lab3=Label(master,text="Name:"+my_user.fname+" "+my_user.lname,bg="orange",fg="black")
        self.lab3.config(font=("algerian",15))
        self.lab3.place(x=30,y=150)
        self.lab3=Label(master,text="Contact No.:"+my_user.mob,bg="orange",fg="black")
        self.lab3.config(font=("algerian",15))
        self.lab3.place(x=30,y=180)
        self.lab3=Label(master,text='ITEM\t\t\t\t\tQuantity\t\t\t\tPrice',bg="orange",fg="black")
        self.lab3.config(font=("algerian",15))
        self.lab3.place(x=30,y=220)
        c.execute("select dessertp.name,count(purchases.item_id),sum(dessertp.price) from purchases inner join dessertp on purchases.item_id=dessertp.item_id group by purchases.item_id;")
        x=c.fetchall()
        dist=0
        ...
        for row in x:
            self.lab3=Label(master,text=str(row[0]),bg="orange",fg="blue")
            self.lab3.config(font=("algerian",12))
            self.lab3.place(x=30,y=250+dist)
            self.lab3=Label(master,text=str(row[1]),bg="orange",fg="blue")
            self.lab3.config(font=("algerian",12))
            self.lab3.place(x=520,y=250+dist)
            self.lab3=Label(master,text=str(row[2]),bg="orange",fg="blue")
            self.lab3.config(font=("algerian",12))
            self.lab3.place(x=900,y=250+dist)
            
            dist=dist+20
        c.execute("select sum(dessertp.price) from purchases inner join dessertp on purchases.item_id=dessertp.item_id")
        pay=c.fetchone()
        self.lab3=Label(master,text="Subtotal="+str(pay[0]),bg="orange",fg="black")
        self.lab3.config(font=("algerian",14))
        self.lab3.place(x=790,y=260+dist)
        self.lab3=Label(master,text="Taxes="+str(round(0.03*pay[0],2)),bg="orange",fg="black")
        self.lab3.config(font=("algerian",14))
        self.lab3.place(x=820,y=260+dist+25)
        self.lab3=Label(master,text="Grand Total="+str(pay[0]+(0.03*pay[0])),bg="orange",fg="black")
        self.lab3.config(font=("algerian",14))
        self.lab3.place(x=759,y=260+dist+50)
        
        self.button3=Button(master,text="Payment",bg="blue",fg="white",command=self.address)
        self.button3.config(font=("bookman old style",19))
        self.button3.place(x=1200,y=10)
    def address(self):
        self.master.destroy()
...
class Address(Frame):
    def __init__(self,master):
        ...
        self.master.geometry('1350x800')
        self.master.configure(bg="orange")
        self.lab3=Label(master,text="Enter delivering address:",bg="orange",fg="black")
        self.lab3.config(font=("algerian",20))
        self.lab3.place(x=500,y=200)
        self.e5=Entry(master,width=50,bd=3)
        self.e5.place(x=630,y=300)
        self.button3=Button(master,text="Confirm",bg="blue",fg="white",command=self.payment)
        self.button3.config(font=("bookman old style",24))
        self.button3.place(x=620,y=500)
    def payment(self):
        self.master.destroy()
        a=Tk()
        obj=Payment(a)
...
class Payment(Frame):
    def __init__(self,master):
        ...
        self.lab3=Label(master,text=("Payment Successful!"),bg="white",fg="black")
        self.lab3.config(font=("algerian",20))
        self.lab3.place(x=520,y=130)     
        self.lab3=Label(master,text=("Your order has been placed "),bg="white",fg="black")
        self.lab3.config(font=("algerian",20))
        self.lab3.place(x=450,y=200)
        self.lab3=Label(master,text=("and will be delivered to you shortly"),bg="white",fg="black")
        self.lab3.config(font=("algerian",20))
        self.lab3.place(x=400,y=270)
        self.lab3=Label(master,text=("Thank you!"),bg="white",fg="black")
        self.lab3.config(font=("algerian",20))
        self.lab3.place(x=570,y=400)
